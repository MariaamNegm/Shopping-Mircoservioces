...
public class adminservice {
     private  final EntityManagerFactory emf = Persistence.createEntityManagerFactory("demoadmin");
    ...
    public String admin( admin c)  {
        ...
        public String addSellCompany(Sellcompany c) throws IOException {
            URL url = new URL("http://localhost:16968/demotrial-1.0-SNAPSHOT/api/sell/addCompany");
        ...
        public List<Sellcompany> getallsellcompanies() throws IOException {
            URL url = new URL("http://localhost:16968/demotrial-1.0-SNAPSHOT/api/sell/getsellcompanies");
