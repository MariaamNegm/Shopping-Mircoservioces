package com.example.demotrial.sellcompany;

import com.example.demotrial.customer.product;
...
public class sellcompanyservice {
    private  final EntityManagerFactory emf = Persistence.createEntityManagerFactory("sell");
